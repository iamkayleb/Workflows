...
gh label create "agent:codex" --color "0052CC" --description "Assigns Codex agent" --repo "iamkayleb/bukay" 2>/dev/null || echo "agent:codex exists"
gh label create "agent:claude" --color "0052CC" --description "Assigns Codex agent" --repo "iamkayleb/bukay" 2>/dev/null || echo "agent:codex exists"
gh label create "agent:gemini" --color "0052CC" --description "Assigns Codex agent" --repo "iamkayleb/bukay" 2>/dev/null || echo "agent:codex exists"
gh label create "agent:retry" --color "D93F0B" --description "Retries keepalive loop" --repo "iamkayleb/bukay" 2>/dev/null || echo "agent:retry exists"
gh label create "agent:needs-attention" --color "D93F0B" --description "Agent needs human help" --repo "iamkayleb/bukay" 2>/dev/null || echo "agent:needs-attention exists"
gh label create "agents:keepalive" --color "0E8A16" --description "Enables keepalive automation" --repo "iamkayleb/bukay" 2>/dev/null || echo "agents:keepalive exists"
gh label create "agents:auto-pilot" --color "0052CC" --description "Runs full auto-pilot issue pipeline" --repo "iamkayleb/bukay" 2>/dev/null || echo "agents:auto-pilot exists"
gh label create "runner:codex" --color "6f42c1" --description "Auto-pilot runner override: codex" --repo "iamkayleb/bukay" 2>/dev/null || echo "runner:codex exists"
gh label create "agents:decompose" --color "5319E7" --description "Triggers issue decomposition workflow" --repo "iamkayleb/bukay" 2>/dev/null || echo "agents:decompose exists"
gh label create "agents:format" --color "5319E7" --description "Formats issue into template" --repo "iamkayleb/bukay" 2>/dev/null || echo "agents:format exists"
gh label create "agents:optimize" --color "5319E7" --description "Analyzes issue and posts suggestions" --repo "iamkayleb/bukay" 2>/dev/null || echo "agents:optimize exists"
gh label create "agents:apply-suggestions" --color "5319E7" --description "Applies optimizer suggestions" --repo "iamkayleb/bukay" 2>/dev/null || echo "agents:apply-suggestions exists"
gh label create "autofix" --color "1D76DB" --description "Triggers autofix on PR" --repo "iamkayleb/bukay" 2>/dev/null || echo "autofix exists"
gh label create "autofix:clean" --color "5319E7" --description "Aggressive autofix mode" --repo "iamkayleb/bukay" 2>/dev/null || echo "autofix:clean exists"
gh label create "autofix:bot-comments" --color "1D76DB" --description "Triggers bot comment autofix sweep" --repo "iamkayleb/bukay" 2>/dev/null || echo "autofix:bot-comments exists"
gh label create "autofix:applied" --color "0E8A16" --description "Autofix was applied" --repo "iamkayleb/bukay" 2>/dev/null || echo "autofix:applied exists"
gh label create "autofix:clean-only" --color "FBCA04" --description "Clean-only autofix" --repo "iamkayleb/bukay" 2>/dev/null || echo "autofix:clean-only exists"
gh label create "verify:create-issue" --color "5319E7" --description "Creates follow-up issue from verifier output" --repo "iamkayleb/bukay" 2>/dev/null || echo "verify:create-issue exists"
gh label create "verify:create-new-pr" --color "5319E7" --description "Creates follow-up PR from verifier output" --repo "iamkayleb/bukay" 2>/dev/null || echo "verify:create-new-pr exists"
```
